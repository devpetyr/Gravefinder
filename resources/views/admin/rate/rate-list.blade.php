    ...
    <div class="py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Rate For Searches</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Rate-List</h1>
            </div>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                    ...
                    @foreach($rate as $key=>$value)
                        <tr>
                            ...
                            <td class="border-0">
                                <a href="{{route('admin_rate_edit').'/'.$value->id}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                            </td>
                        </tr>
                    @endforeach
                    <!-- End of Item -->
