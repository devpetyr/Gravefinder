                                    ...
                                    <div class="panel panel-default credit-card-box">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form
                                                ...
                                                <input type="hidden" name="pricehere" id="pricehere"
                                                       value="{{Helper::rate()->rate}}">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <button class="btn btn-primary btn-lg btn-block" type="submit">
                                                            Pay Now ${{Helper::rate()->rate}}</button>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="my-box">
                            <div class="order-heading">
                                <h3> Order Summary </h3>
                                {{-- <h5>Plan<span>1 on 1 Mentorship</span></h5>
                                <h6>Duration<span>Until Cancelled</span></h6> --}}
                                <h4>Total:<span>${{Helper::rate()->rate}}</span></h4>
                            </div>
                            <div class="col-md-12">
                                <div class="panel panel-default credit-card-box">
                                    <div class="panel-heading display-table">
                                        <div class="row display-tr">
                                            <h3 class="panel-title display-td">Enjoy 3 Searches after Payment!</h3>

                                        </div>
                                    </div>

                                    {{--                                    <a href="{{route('checkout')}}">--}}
                                    {{--                                    <img border="0" alt="" src="{{('assets/images/search.jpg')}}" width="150" height="100">--}}
                                    {{--                                    </a>--}}
